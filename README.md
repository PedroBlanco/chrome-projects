...
1. Descargar el siguiente enlace en una carpeta: [gift app 1-11.crx](https://github.com/PedroBlanco/chrome-projects/blob/master/gift-app-1/package/gift%20app%201-11.crx?raw=true) (la versión actual es la 11).
...
3. Arrastrar el archivo ```gift app 1-11.crx``` desde la carpeta donde nos lo hemos descargado, llevándolo  al interior de la ventana del navegador.
